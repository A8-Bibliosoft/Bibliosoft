...
//    List<Integer> findBookIdByReaderId(String readerid);
    ...
    //所有未还书籍的欠款记录
    @Transactional
    @Query(value = "select * from borrowrecord where borrowrecord.debt>0 and returntime is null",nativeQuery = true)
     ...
     * @return void
     * @author 毛文杰
     * @method name updateDebtByBookid
     * @date 12:47 PM. 11/10/2018
     */
    @Transactional
    @Modifying
